...
**Maka 自己的最佳内证:模型页。** 它已经是 edge-to-edge 行 + divider + 图标板
...
### C5 · 蓝色当纹理(违反 Maka 自己的 Signal-Not-Texture 规则)
...
| 权限与能力 | C3/C8;诊断 dl 报表化 | tiles→一句话+Token;Badge→StatusDot;诊断块收进 Collapsible,行内布局用 MetadataList |
